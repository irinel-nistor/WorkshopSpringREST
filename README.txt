...
cancel them, view their status and find out which machines are free to do the printing.
Therefore, will have to create the following entities: PrintOrder, PrintingStatus, OrderDetails, PrintingMachine.
